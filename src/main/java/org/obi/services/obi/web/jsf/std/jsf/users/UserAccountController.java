...
import org.obi.services.obi.web.jsf.std.entities.users.UserAccount;
...
import org.obi.services.obi.web.jsf.std.sessions.users.UserAccountFacade;
...
public class UserAccountController implements Serializable {
    ...
    @EJB
    private org.obi.services.obi.web.jsf.std.sessions.users.UserAccountFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/OBI").getString("UserAccountCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/OBI").getString("UserAccountUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/OBI").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/OBI").getString("UserAccountDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/OBI").getString("PersistenceErrorOccured"));
        }
    }
