...
import org.obi.services.obi.web.jsf.std.sessions.users.UserRolesFacade;
...
public class UserRolesController implements Serializable {
    ...
    @EJB
    private org.obi.services.obi.web.jsf.std.sessions.users.UserRolesFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/OBI").getString("UserRolesCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/OBI").getString("UserRolesUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/OBI").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/OBI").getString("UserRolesDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/OBI").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public UserRoles getUserRoles(java.lang.Integer id) {
