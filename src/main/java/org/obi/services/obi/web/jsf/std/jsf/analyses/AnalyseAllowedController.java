...
import org.obi.services.obi.web.jsf.std.sessions.analyses.AnalyseAllowedFacade;
...
@Named("analyseAllowedController")
@SessionScoped
public class AnalyseAllowedController implements Serializable {

    private AnalyseAllowed current;
    private DataModel items = null;
    @EJB
    private org.obi.services.obi.web.jsf.std.sessions.analyses.AnalyseAllowedFacade ejbFacade;
    ...
    public String prepareView() {
        current = (AnalyseAllowed) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/OBI").getString("AnalyseAllowedCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/OBI").getString("AnalyseAllowedUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/OBI").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/OBI").getString("AnalyseAllowedDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/OBI").getString("PersistenceErrorOccured"));
        }
    }
    ...
    @FacesConverter(forClass = AnalyseAllowed.class)
    public static class AnalyseAllowedControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof AnalyseAllowed) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + AnalyseAllowed.class.getName());
            }
        }
